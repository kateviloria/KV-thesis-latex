...
\begin{figure}[h]
  \centering
  \subcaptionbox{English}{\includegraphics[width = 3in]{sections/figures/eng_score_distribution.png}}\quad
  \subcaptionbox{German}{\includegraphics[width = 3in]{sections/figures/deu_score_distribution.png}}\\
  \subcaptionbox{Latin}{\includegraphics[width = 3in]{sections/figures/lat_score_distribution.png}}\quad
  \subcaptionbox{Swedish}{\includegraphics[width = 3in]{sections/figures/sve_score_distribution.png}}
