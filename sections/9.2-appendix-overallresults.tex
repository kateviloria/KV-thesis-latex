...
Each top-performing model for English, German, Latin, and Swedish is taken and only one hyperparameter is changed to each possible variable examined. How performance is affected by value changes in one variable is visualised through the graphs below. The figures are grouped by language. 
...
\begin{figure}[h]
  ...
  \subcaptionbox{Vector Dimensions}{\includegraphics[width = 3in]{sections/figures/top-models/eng_dims.png}}\\
  ...
  \caption{English Top Model Hyperparameter Graphs}
...
\begin{figure}[h]
  ...
  \subcaptionbox{Vector Dimensions}{\includegraphics[width = 3in]{sections/figures/top-models/deu_dims.png}}\\
  ...
  \caption{German Top Model Hyperparameter Graphs}
...
\begin{figure}[h]
  ...
  \subcaptionbox{Vector Dimensions}{\includegraphics[width = 3in]{sections/figures/top-models/sve_dims.png}}\\
  ...
  \caption{Swedish Top Model Hyperparameter Graphs}
